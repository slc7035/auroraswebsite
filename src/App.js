    ...
    <Card className={classes.serviceCard}>
      <CardContent>
        <Grid container justify='space-between' direction='column'>
          ...
          <Typography component='p' color='textSecondary' className={classes.serviceCardDescription}>
            {description}
          </Typography>
        </Grid>
      </CardContent>
    ...
    const services = [
      {
        ...
        description: 'Men, women, and children haircuts, shampoo, shaving and hair treatments',
      },
      {
        icon: (<Icon></Icon>),
      ...
      },
      {
        icon: (<Icon></Icon>),
        name: 'Spa and other',
        description: 'Manicures, pedicures, ear piercing, eyelashes, make up and glitter tattoos',
      }
    ];
        ...
        <div className={classes.app}>
          <Grid container spacing={0}>
            <Grid container item>
              <AppBar position='absolute' className={classes.appBar}>
                <Toolbar className={classes.header}>
                  <Grid container item>
                    <Grid item xs>
                      <Button href='#services' variant='text' size='large' disableRipple={true} className={classes.headerSectionBtnOverride}>
                        Services
                      </Button>
                      <Button href='#contact' variant='text' size='large' disableRipple={true} className={classes.headerSectionBtnOverride}>
                        Contact
                      </Button>
                    </Grid>
                    <Grid item xs={6}>
                    ...
                    <Grid item xs>
                      <IconButton href='https://www.facebook.com/awing67' className={classes.socialMediaButtons} aria-label='Facebook page'>
                        <FacebookBox className={classes.socialMediaIcons}/>
                      </IconButton>
                      <IconButton href='#' className={classes.socialMediaButtons} aria-label='Instagram page'>
            ...
            <Grid item className={classes.imageContainer}>
              <img className={classes.splashImage} src={SplashImage} alt='Family' />
            ...
            <Grid id='services' container item spacing={24} justify='center' className={classes.section}>
              <Typography variant='h3' className={classes.sectionTitle}>
                Services
              </Typography>
              <Grid container item justify='space-around'>
                <Grid container item xs={6} justify='space-around'>
                  <ServiceCard classes={classes} name={services[0].name} description={services[0].description} icon={services[0].icon} />
                  <ServiceCard classes={classes} name={services[1].name} description={services[1].description} icon={services[1].icon} />
                </Grid>
                <Grid container item xs={6} justify='space-around'>
                  <ServiceCard classes={classes} name={services[2].name} description={services[2].description} icon={services[2].icon} />
                  <ServiceCard classes={classes} name={services[3].name} description={services[3].description} icon={services[3].icon} />
                </Grid>
              </Grid>
            </Grid>
            <Grid id='about' container item spacing={24} justify='center' className={classes.section}>
              <Typography variant='h3' className={classes.sectionTitle}>
                About
              </Typography>
              <Grid item xs={12}>
                <Map lat={42.9739765} lng={-77.378867} zoom={15} style={styles(typographyTheme).mapContainer}/>
              </Grid>
            </Grid>
          </Grid>
        </div>
